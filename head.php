...
<html lang="en">
 <head>
  ...
  <link href="/common/css/m.css" rel="stylesheet">
  ...
  <header>
	...
	<div class="loginBox">
		<ul>
			...
			<li><i class="fas fa-sign-in-alt"></i>로그인</li>
			<span class="login_line"></span>
			<li><i class="fas fa-user-plus"></i>회원가입</li>
		</ul>
		<div class="sns">
			<span><img src="img/icon_kakao.png" alt=""></span>
